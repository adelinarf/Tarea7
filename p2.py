...
def getLayers(input_points):
	...
	while setOf != []:
		...
		form = run(list(setOf))
		layer = form[2]
		layersFound.append(layer)
		saveImage(setOf,form)
		setOf = set(setOf)-set(layer)
	return len(layersFound)


input_points = [(0, 3), (1, 1), (2, 2), (4, 4),(0, 0), (1, 2), (3, 1), (3, 3)]
print("The amount of layers for ",set(input_points),"is:",getLayers(input_points))
